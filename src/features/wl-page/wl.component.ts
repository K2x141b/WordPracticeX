...
import type { LangKeys, WLGroup } from "../../database/wl-file-paths.js";
import { onClickLangBtn, onClickWlBtn } from "../prac-page/prac.component.js";

const langLabels: LangKeys[] = Object.keys(wlFilePaths) as LangKeys[];
...
export function dispWordLists(WLGroup: LangKeys, wordLists: WLGroup) {
  clearWlBtns();
